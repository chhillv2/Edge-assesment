...
import { Profile } from "../STATIC/user.js";
import EdgeLogo from "../assets/mova-logo-sm.jpeg";
      ...
      >
        ...
        <div className={classes.toolbarContent}>
          <List>
            ...
            <Link to="/Profiles" className={classes.linkfix}>
              <ListItem
                button
                key="1"
                style={{
            ...
            <Link to="/Error" className={classes.linkfix}>
              <ListItem
                button
                key="1"
                style={{
      ...
      <main className={classes.content}>
        <Paper style={{ height: "100%" }}>
          <div className={classes.wrapper}>
            <div className={classes.toolbar} />
            <Switch>
              <Route exact path="/Profiles" component={AuthorsListScreen} />
              <Route exact path="/Error" component={averageListingprice} />
              <Route exact path="/">
